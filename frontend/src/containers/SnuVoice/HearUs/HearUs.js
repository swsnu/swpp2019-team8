...
export class HearUs extends Component {
    ...
    render() {
        ...
        if (this.state.selectedCategory === "All") {
            voteList = this.props.petitionList
                    ...
                    if (i < 5) {
                        return (
                            <Petition
                                ...
                                onClick={() =>
                                    this.onClickDetailButton(petition)
                                }
                            />
                        );
                    } else return undefined;
                });
            deadlineList = this.props.petitionList
                .filter(petition => petition.status === "ongoing")
                .sort((a, b) =>
            ...
            <div>
                ...
                <div className="HearUs">
                    <div className="HearUs_body">
                        <div className="title">
                            <h1>Hear Us</h1>
                            <h6><i>Collecting SNU's Voice</i></h6>
                        </div>
                        <a
                            className="hearushow"
                            href="/tell_me/documents/HEAR-US:도움말"
                        >
                            HEAR-US:도움말
                        </a>
                        <br />
...
export const mapDispatchToProps = dispatch => {
    return {
        getAllPetitions: () => dispatch(actionCreator.getAllPetitions())
    };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(HearUs));
