            ...
            <div>
                ...
                <div className="DebateDetail">
                    <div className="DebateDetail_body">
                        ...
                        <br />
                        <h4 id="debate_title_text">{debateTitle}</h4>
                        <br />
                        <div className="debateContent">{debateContent}</div>
                        <br />
                        <br />
...
export const mapDispatchToProps = dispatch => {
    return {
        ...
        onGetDebate: (selectedDocument, debate_id) =>
            dispatch(
                actionCreators.getDebate(selectedDocument.title, debate_id)
            ),
        ...
        onPostDebateComment: (comment, debate_id) =>
            dispatch(
                actionCreators.postDebateComment(
                    { comment: comment, debate: debate_id },
                    debate_id
                )
            )
    };
