...
export const GET_USER_TO_MOD = "GET_USER_TO_MOD";
export const CHECK_SIGN_IN = 'CHECK_SIGN_IN';
export const CHECK_EMAIL_DUPLICATE = 'CHECK_EMAIL_DUPLICATE';
export const CHECK_NICKNAME_DUPLICATE = 'CHECK_NICKNAME_DUPLICATE';
export const CHECK_STUDENT_ID_DUPLICATE = 'CHECK_STUDENT_ID_DUPLICATE';
export const POST_DOCUMENT = 'POST_DOCUMENT';
export const GET_DOCUMENT = 'GET_DOCUMENT';
export const GET_LATEST_DOCUMENTS = 'GET_LATEST_DOCUMENTS';
...
export const GET_PETITION_BY_DOCUMENT = 'GET_PETITION_BY_DOCUMENT';
export const GET_MY_PETITIONS = 'GET_MY_PETITIONS';
export const GET_MY_PETITIONS_BY_COMMENT = 'GET_MY_PETITIONS_BY_COMMENT';
